...
export const CALCULATION_TOOLTIPS = {
  ...
  monthlySavings: `Your payment = P&I on (existing balance + reno cost) at your rate, 30 years. Comparable = P&I on 80% of post-reno value at market rate. Savings = Comparable − Your payment. We use your real rate so the comparison is as accurate as possible.`,
...
export const CALCULATION_EXPLANATIONS_FOR_CHATBOT = {
  ...
  monthlySavings: `Your payment = P&I on (existing balance + reno cost) at the user's rate, 30 years. Comparable = P&I on 80% of post-reno value at market rate. Savings = Comparable − Your payment. We derive balance from their current P&I when they enter it, or use manual balance or a conservative LTV estimate so the comparison stays accurate.`,
